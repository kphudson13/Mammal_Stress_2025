...
BasCrtstnMass_Plot
ggsave(filename = "Outputs/Primate_Filtered/BasCrtstnMass_Plot.png",
       width = 5,
       height = 4)
...
ElvCrtstnBasCrtstn_Plot
ggsave(filename = "Outputs/Primate_Filtered/ElvCrtstnBasCrtstn_Plot.png",
       width = 5,
       height = 4)
...
BasCrtsolMass_Plot
ggsave(filename = "Outputs/Primate_Filtered/BasCrtsolMass_Plot.png",
       width = 5,
       height = 4)
...
ElvCrtsolBasCrtsol_Plot
ggsave(filename = "Outputs/Primate_Filtered/ElvCrtsolBasCrtsol_Plot.png",
       width = 5,
       height = 4)
...
#export stats table 
png("Outputs/Primate_Filtered/StatsTab_PGLS.png", 
...
#export stats table 
png("Outputs/Primate_Filtered/StatsTab_Ordinary.png", 
...
write.csv(StatsTab_PGLS, "Outputs/Primate_Filtered/StatsTab_PGLS.csv")
write.csv(StatsTab_Ordinary, "Outputs/Primate_Filtered/StatsTab_Ordinary.csv")
